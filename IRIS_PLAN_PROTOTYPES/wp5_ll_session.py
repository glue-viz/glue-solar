"""Does a line-list layer survive a glue session round trip? Synthetic spectrum only; does not prove complete IRIS sessions."""
import os, sys
...
def main():
    with TemporaryDirectory(prefix="iris-line-session-") as directory:
        ...
        path = os.path.join(directory, "wp5_lines.glu")
