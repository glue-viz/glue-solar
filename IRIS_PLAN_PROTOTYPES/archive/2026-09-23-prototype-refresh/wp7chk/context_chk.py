...
from glue_solar.sources.loaders.iris import _GlueWCS, _observation_label
...
# ---- WP1 link_hpc (copied verbatim from briefs/wp1-linking.md, lives in glue_solar/sources/loaders/iris.py after WP1)
