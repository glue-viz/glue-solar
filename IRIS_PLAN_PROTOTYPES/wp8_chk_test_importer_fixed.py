...
from glue_solar.conftest import MD5, OBS_A, OBS_B, OBS_C, OBS_S, iris_tree, irispy_test_files  # noqa: F401
from glue_solar.sources.loaders.iris import image_data, raster_data
from wp8_chk_proto_fix import ProtoImporterFixed as QtIRISImporter
import wp8_scan as scan
...
def test_recursive_toggle_rescans(qtbot, dialog):
