...
if __name__ == "__main__":
    ...
    print("  wavelength A:", wl[[0, -1]], "step", np.diff(wl).mean(), "rest (TWAVE) A:"(d), "-> outside window, argmax seed used")
    ...
    print("sns Mg II k:", mg.shape, "rest A:"(mg), "window", wavelength_angstrom(mg)[[0, -1]])
    ...
    print("stack:", st.label, st.shape, "meta type", type(st.meta).__name__, "rest:"(st))
    try:
